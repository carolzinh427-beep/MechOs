...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: any) {
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" style={disableStepIndicators ? { pointerEvents: 'none', opacity: 0.5 } : {}} animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#181C28', color: '#a1a1aa', borderColor: '#242838' },
          active: { scale: 1, backgroundColor: '#00E676', color: '#000000', borderColor: '#00E676' },
          complete: { scale: 1, backgroundColor: '#00E676', color: '#000000', borderColor: '#00E676' }
        }}
...
function StepConnector({ isComplete }: { isComplete: boolean }) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: '#00E676' }
  };
