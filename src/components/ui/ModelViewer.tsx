  ...
  return (
    <Html center>
      {placeholderSrc ? (
        ...
        <div style={{ color: '#00E676', fontWeight: 'bold', fontSize: 13, background: 'rgba(15,17,26,0.9)', padding: '6px 12px', borderRadius: 20, border: '1px solid rgba(0,230,118,0.4)', fontFamily: 'sans-serif' }}>
...
export const ModelViewer: React.FC<ModelViewerProps> = ({
  ...
  const capture = () => {
    ...
    a.download = 'mechos-3d-model.png';
    a.href = urlPNG;
    a.click();
