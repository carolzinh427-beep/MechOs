  ...
  const problems = [
    {
      ...
      icon: <MessageSquareOff className="w-5 h-5 text-rose-400" />
    },
    {
      ...
      icon: <FileX className="w-5 h-5 text-rose-400" />
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-14">
          ...
          <p className="text-sm sm:text-base text-zinc-400">
            Trabalhar sem um sistema integrado gera desperdício de tempo, erros em ordens de serviço e perda direta de faturamento.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {problems.map((prob, idx) => (
            <Card
              key={idx}
              className="bg-[#0F111A] border-rose-500/20 hover:border-rose-500/40 p-6 space-y-3"
            >
        ...
        <div className="mt-16 text-center space-y-4">
          <div className="w-12 h-12 rounded-full bg-[#00E676]/10 border border-[#00E676] flex items-center justify-center mx-auto text-[#00E676] animate-bounce">
            <ArrowDown className="w-6 h-6" />
          </div>
          <p className="text-2xl sm:text-3xl font-black text-[#00E676] tracking-tight">
