    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          {/* Subheadline */}
          <p className="text-base sm:text-xl text-zinc-400 font-medium max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <a href="#como-funciona" className="w-full sm:w-auto">
              <Button variant="outline" size="xl" icon={<Play className="w-4 h-4 fill-current" />} className="w-full">
                Ver como funciona
              </Button>
            </a>
          </div>
          ...
          {/* Trust note */}
          <p className="text-xs sm:text-sm text-zinc-500 font-medium flex items-center justify-center gap-2 pt-2">
        ...
        <div className="mt-14 md:mt-20 relative max-w-5xl mx-auto">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-[#00E676]/40 via-emerald-500/20 to-[#00E676]/40 rounded-3xl blur-lg opacity-70 group-hover:opacity-100 transition duration-1000"></div>

          {/* Mockup Container */}
          <div className="relative bg-[#0F111A] border border-[#242838] rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden text-left">
            {/* Mockup Top Window Bar */}
            <div className="bg-[#141722] border-b border-[#242838] px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-rose-500/80"></div>
                <div className="w-3 h-3 rounded-full bg-amber-500/80"></div>
                <div className="w-3 h-3 rounded-full bg-emerald-500/80"></div>
                <span className="ml-3 text-[11px] font-mono text-zinc-400">app.mechos.com.br/dashboard</span>
              </div>

              {/* Segment Pill indicator */}
              <span className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#00E676]/10 text-[#00E676] text-[10px] font-bold border border-[#00E676]/30">
            ...
            <div className="p-4 sm:p-6 md:p-8 space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                {/* Metric 1 */}
                <div className="p-4 rounded-xl bg-[#141722] border border-[#242838] hover:border-[#00E676]/50 transition-all">
                  <div className="flex items-center justify-between text-zinc-400 mb-1">
                    <span className="text-[11px] font-bold uppercase tracking-wider">Faturamento (Mês)</span>
                    <TrendingUp className="w-4 h-4 text-[#00E676]" />
                  </div>
                  <p className="text-xl sm:text-2xl font-black text-white">R$ 48.920<span className="text-xs text-zinc-400">,00</span></p>
                  <span className="text-[10px] font-bold text-[#00E676] inline-flex items-center gap-0.5 mt-1">
                    +17,8% vs mês anterior
                  </span>
                </div>
